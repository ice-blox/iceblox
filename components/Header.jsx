...
const Header = () => {
  ...
  return (
    <section
      ref={headerRef}
      className="overflow-hidden relative h-screen min-h-[500px] flex flex-col justify-start items-center bg-transparent space-y-6 md:space-y-8"
    >
      <Cube
        x={x}
        y={y}
        size="59px"
        position="left-[7%] top-[0%] md:top-[20%]"
      />
      <Cube
        x={x}
        y={y}
        size="52px"
        position="left-[55%] top-[5%] md:top-[15%]"
      />
      <Cube
        x={x}
        y={y}
        size="52px"
        position="right-[7%] top-[5%] md:top-[16%]"
      />
      ...
      <Cube
        ...
        y={y}
        size="29px"
        position="left-[15%] top-[25%] md:top-[45%]"
      />
      <Cube
        x={x}
        y={y}
        size="60px"
        position="right-[15%] top-[15%] md:top-[40%]"
      />
      ...
      <Cube
        ...
        y={y}
        size="60px"
        position="left-[4%] bottom-[0%] md:bottom-[15%]"
      />
      <Cube
        x={x}
        y={y}
        size="75px"
        position="left-[23%] bottom-[0%] md:bottom-[18%]"
      />
      <Cube
        x={x}
        y={y}
        size="29px"
        position="right-[27%] bottom-[0%] md:bottom-[20%]"
      />
      <Cube
        x={x}
        y={y}
        size="90px"
        position="right-[7%] bottom-[0%] md:bottom-[25%]"
      />
